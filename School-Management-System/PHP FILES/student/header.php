...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="attendance-current-month.php">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown active" style="display: block;">
             ...
             <div class="siderbar-profile-pic">
                 <img src="../admin/'.$ro[10].'" class="profile-img-circle box-center" alt="User Image">
             </div>
      ...
      <hr>
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fab fa-atlassian"></i><span style="margin-left: 10px;">My Attendance</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="attendance-current-month.php">Current Attendance</a></li>
        </ul>
      </li>
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fab fa-atlassian"></i><span style="margin-left: 10px;">Manage Assignment(Pro)</span></a>
        <ul class="dropdown-menu">
