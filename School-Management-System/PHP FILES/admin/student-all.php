...
<title><?php echo $_SESSION['school_name']; ?> - All Students</title>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
          ...
          echo'<tr>
            ...
            echo'<td>
                  <a href="student-view.php?student='.$ro[0].'">
                  <img src="uploads/view.PNG" style="width:25px; 
                    background-color:white;
                    border-radius:0px; border:0px solid white;"/></a>
                  <a href="student-edit.php?student='.$ro[0].'">
                  <img src="uploads/pencil.PNG" style="width:25px; 
                    background-color:white;
                    border-radius:0px; border:0px solid white;"/></a>
                  <a href="student-all.php?id='.$ro[0].'"><img src="uploads/trash.PNG" style="width:25px; 
                    background-color:white;
                    border-radius:0px; border:0px solid white;"/></a>
                </td>
              </tr>';
...
$q1 = "DELETE FROM students where id='$id'";
$r1 =mysqli_query($conn,$q1);

$q2 = "DELETE FROM student_dues where student_id='$id'";
$r2 =mysqli_query($conn,$q2);

$link = "<script>window.open('student-all.php','_self')</script>";
echo $link;
$conn->close();
}
?>