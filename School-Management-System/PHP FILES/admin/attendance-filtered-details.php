  ...
  <div class="card">
    <div class="card-header">
        ...
        if(isset($_GET['search'])){
          ...
          $q = "SELECT * FROM class WHERE id='$class'";
          $r =mysqli_query($conn,$q);
          $ro = mysqli_fetch_array($r);
          echo '<h4>Monthly Attendance Record for <br> Class = '.$ro[1].'<br> Month = '.$date.'</h4>';
        }
        ?>
    ...
    <div class="card-body">
      ...
      <table class="table table-striped table-hover" id="save-stage">
        ...
        if($count%2 == 0){
            ...
            echo'<td style="color:white;">'.$count.'</td>
                 <td style="color:white;">'.$ro[1].'</td>';
            ...
            while($day<32){
                ...
                //GET ATTENDANCE
                $q2 = "SELECT * FROM attendance WHERE student='$ro[0]' AND date='$date1'";
                $r2 =mysqli_query($conn,$q2);
                $ro2 = mysqli_fetch_array($r2);
                if(isset($ro2[0])){
                    echo'<td style="text-align:center; color:white;">'.$ro2[1].'</td>';
                }
                else{
