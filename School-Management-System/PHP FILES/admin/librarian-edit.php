                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    if(isset($_GET['librarian'])){
                      $_SESSION['editlibrarian'] = $_GET['librarian'];
                      $id = $_SESSION['editlibrarian'];
                    }
                    else{
                      $id = $_SESSION['editlibrarian'];
                    }
                  ...
                  <form action="librarian-edit.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      <?php
                      include ("conn.php");
                      ...
                      <div class="col-12 col-md-12 col-lg-12">
                        <div class="form-group">
                          <button type="submit" name="updatelibrarian" class="btn btn-primary">Update Record</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
if($target_file == $target_dir){
  ...
  $link = "<script>window.open('librarian-edit.php','_self')</script>";
  echo $link;
$conn->close();
}
?>