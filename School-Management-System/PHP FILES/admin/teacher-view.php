...
<title><?php echo $_SESSION['school_name']; ?> - View Teacher Details</title>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-12 col-md-12 col-lg-12">
                        <div>
                          <label><p><img src="'.$ro[9].'" style="width:100px; height:100px;" /></p></label>
                        </div>
                      </div>
                      ...
                      <div class="col-4 col-md-4 col-lg-4">
                        <div>
                          <label>Registration Date : <p>'.$ro[8].'</p></label>
                        </div>
                      </div>
                    </div>
                  </div>';
