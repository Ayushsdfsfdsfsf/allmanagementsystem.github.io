...
<title><?php echo $_SESSION['school_name']; ?> - Add Accountant</title>
            ...
            <div class="row">              
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <form action="accountant-add.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
...
$sql = "INSERT INTO accountant(fullname,email,password,designation,phone_number,whatsapp_number,reg_date,profile_pic) VALUES (
'$fullname',
'$email',
'$password',
'$designation',
...
$link = "<script>window.open('accountant-add.php','_self')</script>";
echo $link;
}
$conn->close();
}
